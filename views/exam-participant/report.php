...
<table id="customers" align="center">
    ...
    <tr>
        ...
        <td class="border-cell">:</td>
        <td class="border-cell"><?=$peserta->getMeta('tempat_tanggal_lahir')?$peserta->getMeta('tempat_tanggal_lahir'):$peserta->getMeta('tempat_lahir').', '.$peserta->getMeta('tanggal_lahir');?></td>
    </tr>
    <tr>
