...
<table id="customers" align="center">
    ...
    <tr>
        ...
        <td class="border-cell">:</td>
        <td class="border-cell" colspan="2"><?=$worksheet->getCellByColumnAndRow(14, $row)->getValue()?></td>
    </tr>
    <tr>
        ...
        <td class="border-cell"><?=$worksheet->getCellByColumnAndRow(18, $row)->getValue()?></td>
    </tr>
    <tr>
