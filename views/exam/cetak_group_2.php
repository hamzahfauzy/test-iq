...
<table id="customers" align="center">
    <tr>
        ...
        <td class="border-cell w-bold center" width="250" colspan="2"><?=$worksheet->getCellByColumnAndRow(16, $row)->getValue()?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="center border-cell w-bold">:</td>
        <td class="border-cell w-bold center" colspan="2"><?=$worksheet->getCellByColumnAndRow(14, $row)->getValue()?></td>
    </tr>
    <tr>
        ...
        <td class="border-cell w-bold center"><?=$worksheet->getCellByColumnAndRow(18, $row)->getValue()?></td>
    </tr>
    <tr>
